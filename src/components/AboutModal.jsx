...
const AboutModal = ({ isOpen, isMinimized, onClose, onMinimize, onRestore, onGamesModalOpen }) => {
      ...
      <div className="window" style={{
        ...
        <div className="window-body" style={{
          ...
          <div style={{ 
            ...
            {/* Contenu About */}
            <AboutContent onGamesModalOpen={onGamesModalOpen} />
          </div>
